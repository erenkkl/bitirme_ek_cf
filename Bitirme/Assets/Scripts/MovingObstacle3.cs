...
public class MovingObstacle3 : MonoBehaviour
{
    [SerializeField] private Vector3 start = new Vector3(150f, 30f, 205f);
    [SerializeField] private Vector3 end   = new Vector3(150f, 30f, 230f);
